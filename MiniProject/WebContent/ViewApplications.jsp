		...
		<c:forEach var="applicant" items="${requestScope.applicants}">
			<tr>
				...
				<c:if
					test="${(requestScope.role eq 'mac') || (requestScope.role eq 'admin') }">
					<th><a
						href="viewApplication?page=updateApplicationStatus&scheduledProgramId=${applicant.scheduledProgramId}&applicationId=${applicant.applicationId}&status=Accepted"><button
								class="btn-info">Accept&nbsp;&nbsp;</button></a> <a
						href="viewApplication?page=updateApplicationStatus&scheduledProgramId=${applicant.scheduledProgramId}&applicationId=${applicant.applicationId}&status=Rejected">
